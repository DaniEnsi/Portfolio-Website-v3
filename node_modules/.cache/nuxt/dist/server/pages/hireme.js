exports.ids = [63,0,21,25,54,55,56,57,59];
exports.modules = {
...
var render = function render() {
  ...
  return _c('SmartLink', {
    staticClass: "flex space-x-3 px-4 py-1.5 rounded-md transition-colors hover:bg-gray-200/40 dark:hover:bg-neutral-800/40 select-none items-center",
    attrs: {
    ...
    staticClass: "text-sm opacity-50 truncate"
  }, [_vm._v("\n      " + _vm._s(_vm.monthly ? "Monthly" : "One time") + "\n    ")])])], 1);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./src/components/Card/Sponsor.vue?vue&type=template&id=04eb52d1&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/hireme.vue?vue&type=template&id=b61350d2&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c,
      _setup = _vm._self._setupProxy;
  ...
  return _c('div', {
    staticClass: "py-4"
  }, [_vm._ssrNode("<div class=\"space-y-12 text-gray-500 sm:w-9/12 dark:text-neutral-600\">", "</div>", [_vm._ssrNode("<header class=\"space-y-2 my-12 px-4\"><h1 class=\"text-gray-700 text-4xl dark:text-neutral-300\">Hire Me</h1> <p>\n        I'm currently available for hire. If you're interested in working with me, you can contact me via email or Discord. I'm also open to freelance work.\n        Thank you ♥\n      </p> <p class=\"text-xs\">\n        P.S. We will talk about &quot;<span class=\"border-b border-black/10 dark:border-white/10\">Prices</span>&quot; after we talk about the project.\n      </p></header> "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('Title', [_vm._v("Support Me On")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"flex flex-wrap gap-x-4 gap-y-2 mx-4\">", "</div>", [_c('Button', {
    directives: [{
      name: "tippy",
      rawName: "v-tippy",
      value: {
    ...
    attrs: {
      "variant": "github",
      "href": _vm.getSponsorLinks.github,
      "blank": ""
    },
    scopedSlots: _vm._u([{
      key: "icon",
    ...
    attrs: {
      "variant": "patreon",
      "href": _vm.getSponsorLinks.patreon,
      "blank": ""
    },
    scopedSlots: _vm._u([{
      key: "icon",
  ...
  }, [_vm._v("\n\n          Become a Patron\n        ")])], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('SmartLink', {
    staticClass: "flex space-x-2 justify-between mx-4 items-center",
    attrs: {
  ...
  }, [_vm._v("Sponsors")]), _vm._v(" "), _c('IconBrand', {
    staticClass: "h-7 w-7 dark:hover:text-white hover:text-black transition-colors",
    attrs: {
      "brand": "github"
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div>", "</div>", [_c('transition', {
    attrs: {
      "name": "fade",
      "mode": "out-in"
    }
  }, [_vm.$fetchState.pending ? _c('SkeletonLoader', {
    staticClass: "w-full py-4",
    attrs: {
      "type": "spinner"
    }
  }) : _vm.$fetchState.error !== null ? _c('p', [_vm._v("  No Sponsors yet :(")]) : !_vm.$fetchState.pending && !_vm.$fetchState.error && _vm.sponsors.length === 0 ? _c('p', [_vm._v("\n            No sponsors yet :(\n          ")]) : _c('div', {
    staticClass: "grid grid-cols-2 lg:grid-cols-3 gap-2"
  ...
  }), _vm._v(" "), _vm._l(_vm.getSortedSponsors.oneTime, function (item, index) {
    return _c('CardSponsor', {
  ...
  })], 2)], 1)], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('Title', [_vm._v("Bank Accounts")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"grid px-4 gap-4\">", "</div>", _vm._l(_vm.accounts, function (account, index) {
    return _vm._ssrNode("<div class=\"flex h-full items-center\">", "</div>", [_vm._ssrNode("<div class=\"rounded-l bg-gray-200/75 dark:bg-neutral-800/50\">", "</div>", [_c('SmartImage', {
      staticClass: "rounded-l h-24 w-24",
      attrs: {
        "src": account.image
      }
    })], 1), _vm._ssrNode(" <div class=\"rounded-tr rounded-br flex h-full bg-gray-200/50 w-full pl-4 items-center dark:bg-neutral-800/75\"><div><h3 class=\"font-medium text-lg text-gray-900 dark:text-neutral-300\">" + _vm._ssrEscape("\n                " + _vm._s(account.name) + "\n              ") + "</h3> " + (account.revealed == true ? "<span class=\"text-gray-800 dark:text-neutral-500\">" + _vm._ssrEscape("\n                " + _vm._s(account.iban) + "\n              ") + "</span>" : "<span class=\"cursor-pointer text-gray-800 dark:text-neutral-500 hover:underline\">\n                Click to reveal\n              </span>") + "</div></div>")], 2);
  }), 0)], 2)], 2)]);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./src/pages/hireme.vue?vue&type=template&id=b61350d2&

// EXTERNAL MODULE: external "vue"
var external_vue_ = __webpack_require__(0);
var external_vue_default = /*#__PURE__*/__webpack_require__.n(external_vue_);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--12-0!./node_modules/ts-loader??ref--12-1!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/hireme.vue?vue&type=script&lang=ts&

/* harmony default export */ var hiremevue_type_script_lang_ts_ = (external_vue_default.a.extend({
  data() {
    return {
      sponsors: [],
      accounts: [{
  ...
  async fetch() {
    const {
      data
    } = await this.$axios.get("https://raw.githubusercontent.com/DaniEnsi/.github/main/sponsors.json");
    this.sponsors = data;
  },

  head() {
    const title = "Donate";
    const description = "Like my projects? You can donate to me to boost my performance and help me create more, better projects in the future!";
    return {
      title,
  ...
  computed: {
    ...
    getSortedSponsors() {
      ...
      const sortByPrice = (a, b) => b.monthlyDollars - a.monthlyDollars;
...
// CONCATENATED MODULE: ./src/pages/hireme.vue?vue&type=script&lang=ts&
 /* harmony default export */ var pages_hiremevue_type_script_lang_ts_ = (hiremevue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./src/pages/hireme.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_hiremevue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var hireme = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {Title: __webpack_require__(93).default,IconBrand: __webpack_require__(99).default,Button: __webpack_require__(10).default,SmartImage: __webpack_require__(16).default,SmartLink: __webpack_require__(9).default,SkeletonLoader: __webpack_require__(92).default,CardSponsor: __webpack_require__(119).default})
