...
var require_caster = __commonJS({
  "node_modules/lastfm-typed/dist/caster.js"(exports) {
    ...
    function convertSearch(res) {
      ...
      res.meta.query = __spreadValues(__spreadValues({}, res.meta.query), res["opensearch:Query"]);
  ...
  "node_modules/lastfm-typed/dist/request.js"(exports) {
    ...
    var LFMRequest = class {
      ...
      async post() {
        ...
        const requestParam = __spreadProps(__spreadValues({}, this.params), {
          api_key: this.key,
          format: "json",
          api_sig
        });
      ...
      getSignature() {
        const paramObj = __spreadProps(__spreadValues({}, this.params), {
          api_key: this.key
        });
  ...
  "node_modules/lastfm-typed/dist/classes/tag.js"(exports) {
    ...
    var TagClass = class extends base_1.default {
      async getInfo(firstInput, params) {
        ...
        return (await this.sendRequest(__spreadValues(__spreadValues({ method: "tag.getInfo" }, firstInput), params))).tag;
      }
      ...
      async getTop(method, firstInput, params) {
        ...
        return await this.sendRequest(__spreadValues(__spreadValues({ method }, firstInput), params));
      }
    };
  ...
  "node_modules/lastfm-typed/dist/classes/chart.js"(exports) {
    ...
    var ChartClass = class extends base_1.default {
      ...
      async getTop(method, params) {
        ...
        return await this.sendRequest(__spreadValues({ method }, params));
      }
    };
  ...
  "node_modules/lastfm-typed/dist/classes/auth.js"(exports) {
    ...
    var AuthClass = class extends base_1.default {
      ...
      async getSession(firstInput) {
        ...
        const res = (await this.sendRequest(__spreadValues({ method: "auth.getSession" }, firstInput))).session;
      ...
      async getMobileSession(firstInput, password, token) {
        ...
        return (await this.sendRequest(__spreadValues({ method: "auth.getMobileSession" }, firstInput))).session;
      }
    };
  ...
  "node_modules/lastfm-typed/dist/classes/album.js"(exports) {
    ...
    var AlbumClass = class extends base_1.default {
      async addTags(firstInput, album, tags, sk) {
        ...
        return await this.sendRequest(__spreadValues({ method: "album.addTags" }, firstInput));
      }
      async getInfo(firstInput, params) {
        var _a, _b;
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "album.getInfo" }, firstInput), params))).album;
      ...
      async getTags(firstInput, usernameOrSessionKey, params) {
        let req = (0, caster_1.addConditionals)(__spreadValues(__spreadValues({}, firstInput), params), { user: usernameOrSessionKey });
        let res = this.convertGetTags((await this.sendRequest(__spreadValues({ method: "album.getTags" }, req))).tags);
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async getTopTags(firstInput, params) {
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "album.getTopTags" }, firstInput), params))).toptags;
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async removeTag(firstInput, album, tag, sk) {
        firstInput = (0, caster_1.convertString)(firstInput, "artist", { album, tag, sk });
        return await this.sendRequest(__spreadValues({ method: "album.removeTag" }, firstInput));
      }
      async search(firstInput, params) {
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "album.search" }, firstInput), params))).results;
  ...
  "node_modules/lastfm-typed/dist/classes/artist.js"(exports) {
    ...
    var ArtistClass = class extends base_1.default {
      async addTags(firstInput, tags, sk) {
        ...
        firstInput.tags = (0, caster_1.joinArray)(firstInput.tags);
        return await this.sendRequest(__spreadValues({ method: "artist.addTags" }, firstInput));
      }
      async getCorrection(artist) {
        var _a, _b;
        artist = (0, caster_1.convertString)(artist, "artist", {});
        let res = ((_b = (_a = await this.sendRequest(__spreadValues({ method: "artist.getCorrection" }, artist))) === null || _a === void 0 ? void 0 : _a.corrections) === null || _b === void 0 ? void 0 : _b.correction) || {};
      ...
      async getInfo(firstInput, params) {
        var _a, _b, _c;
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.getInfo" }, firstInput), params))).artist;
      ...
      async getSimilar(firstInput, params) {
        var _a;
        this.checkLimit((_a = params === null || params === void 0 ? void 0 : params.limit) !== null && _a !== void 0 ? _a : firstInput.limit, 1e3);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.getSimilar" }, firstInput), params))).similarartists;
        res.meta = res["@attr"];
        delete res["@attr"];
      ...
      async getTags(firstInput, usernameOrSessionKey, params) {
        let req = (0, caster_1.addConditionals)(__spreadValues(__spreadValues({}, firstInput), params), { user: usernameOrSessionKey });
        let res = this.convertGetTags((await this.sendRequest(__spreadValues({ method: "artist.getTags" }, req))).tags);
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async getTopAlbums(firstInput, params) {
        var _a;
        this.checkLimit((_a = params === null || params === void 0 ? void 0 : params.limit) !== null && _a !== void 0 ? _a : firstInput.limit, 1e3);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.getTopAlbums" }, firstInput), params))).topalbums;
      ...
      async getTopTags(firstInput, params) {
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.getTopTags" }, firstInput), params))).toptags;
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async getTopTracks(firstInput, params) {
        var _a;
        this.checkLimit((_a = params === null || params === void 0 ? void 0 : params.limit) !== null && _a !== void 0 ? _a : firstInput.limit, 1e3);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.getTopTracks" }, firstInput), params))).toptracks;
      ...
      async removeTag(firstInput, tag, sk) {
        ...
        return await this.sendRequest(__spreadValues({ method: "artist.removeTag" }, firstInput));
      }
      async search(firstInput, params) {
        var _a;
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "artist.search" }, firstInput), params))).results;
        res = (0, caster_1.convertSearchWithQuery)(res);
  ...
  "node_modules/lastfm-typed/dist/classes/library.js"(exports) {
    ...
    var LibraryClass = class extends base_1.default {
      async getArtists(firstInput, params) {
        ...
        this.checkLimit((_a = params === null || params === void 0 ? void 0 : params.limit) !== null && _a !== void 0 ? _a : firstInput === null || firstInput === void 0 ? void 0 : firstInput.limit, 1e3);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "library.getArtists" }, firstInput), params))).artists;
        return (0, caster_1.convertExtendedMeta)(res, "artist");
      }
    };
  ...
  "node_modules/lastfm-typed/dist/classes/track.js"(exports) {
    ...
    var TrackClass = class extends base_1.default {
      async addTags(artist, track, tags, sk) {
        ...
        return await this.sendRequest(__spreadValues({ method: "track.addTags" }, artist));
      }
      async getCorrection(artist, track) {
        var _a, _b;
        artist = (0, caster_1.convertString)(artist, "artist", { track });
        let res = ((_b = (_a = await this.sendRequest(__spreadValues({ method: "track.getCorrection" }, artist))) === null || _a === void 0 ? void 0 : _a.corrections) === null || _b === void 0 ? void 0 : _b.correction) || {};
      ...
      async getInfo(track, params) {
        var _a, _b;
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "track.getInfo" }, track), params))).track;
      ...
      async getSimilar(track, params) {
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "track.getSimilar" }, track), params))).similartracks;
        return (0, caster_1.convertExtendedMeta)(res, "track");
      }
      async getTags(track, username2, params) {
        track = (0, caster_1.addConditionals)(track, { username: username2 });
        let res = this.convertGetTags((await this.sendRequest(__spreadValues(__spreadValues({ method: "track.getTags" }, track), params))).tags);
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async getTopTags(track, params) {
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "track.getTopTags" }, track), params))).toptags;
        return (0, caster_1.convertBasicMetaTag)(res);
      }
      async love(artist, track, sk) {
        artist = (0, caster_1.convertString)(artist, "artist", { track, sk });
        return await this.sendRequest(__spreadValues({ method: "track.love" }, artist));
      }
      async removeTag(artist, track, tag, sk) {
        artist = (0, caster_1.convertString)(artist, "artist", { track, sk, tag });
        return await this.sendRequest(__spreadValues({ method: "track.removeTag" }, artist));
      }
      async scrobble(firstInput, scrobbles) {
        ...
        let res = (await this.sendRequest(__spreadProps(__spreadValues({ method: "track.scrobble" }, params), { sk: firstInput.sk }))).scrobbles;
        res.meta = (0, caster_1.convertMeta)(res["@attr"]);
        delete res["@attr"];
      ...
      async search(track, params) {
        ...
        this.checkLimit((_a = params === null || params === void 0 ? void 0 : params.limit) !== null && _a !== void 0 ? _a : track === null || track === void 0 ? void 0 : track.limit, 1e3);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "track.search" }, track), params))).results;
      ...
      async unlove(artist, track, sk) {
        artist = (0, caster_1.convertString)(artist, "artist", { track, sk });
        return await this.sendRequest(__spreadValues({ method: "track.unlove" }, artist));
      }
      async updateNowPlaying(artist, track, sk, params) {
        artist = (0, caster_1.convertString)(artist, "artist", { track, sk });
        return await this.sendRequest(__spreadValues(__spreadValues({ method: "track.updateNowPlaying" }, artist), params));
      }
    };
  ...
  "node_modules/lastfm-typed/dist/classes/user.js"(exports) {
    ...
    var UserClass = class extends base_1.default {
      async getFriends(firstInput, params) {
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getFriends" }, firstInput), params))).friends;
      ...
      async getInfo(firstInput, params) {
        firstInput = (0, caster_1.convertString)(firstInput, "user", {});
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getInfo" }, firstInput), params))).user;
      ...
      async getLovedTracks(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getLovedTracks" }, firstInput), params))).lovedtracks;
        res.meta = (0, caster_1.convertMeta)(res["@attr"]);
        delete res["@attr"];
      ...
      async getPersonalTags(firstInput, tag, taggingType, params) {
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getPersonalTags" }, firstInput), params))).taggings;
      ...
      async getRecentTracks(firstInput, params) {
        ...
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getRecentTracks" }, firstInput), params))).recenttracks;
        res.meta = (0, caster_1.convertMeta)(res["@attr"]);
        delete res["@attr"];
      ...
      async getTopAlbums(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getTopAlbums" }, firstInput), params))).topalbums;
        return (0, caster_1.convertExtendedMeta)(res, "album");
      }
      async getTopArtists(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getTopArtists" }, firstInput), params))).topartists;
        return (0, caster_1.convertExtendedMeta)(res, "artist");
      }
      async getTopTags(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getTopTags" }, firstInput), params))).toptags;
        return (0, caster_1.convertExtendedMeta)(res, "tag");
      }
      async getTopTracks(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getTopTracks" }, firstInput), params))).toptracks;
        return (0, caster_1.convertExtendedMeta)(res, "track");
      }
      async getWeeklyAlbumChart(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getWeeklyAlbumChart" }, firstInput), params))).weeklyalbumchart;
        res.meta = (0, caster_1.convertMeta)(res["@attr"]);
        delete res["@attr"];
      ...
      async getWeeklyArtistChart(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getWeeklyArtistChart" }, firstInput), params))).weeklyartistchart;
        return (0, caster_1.convertExtendedMeta)(res, "artist");
      }
      ...
      async getWeeklyTrackChart(firstInput, params) {
        firstInput = this.checkLimitAndConvertString(firstInput, params);
        let res = (await this.sendRequest(__spreadValues(__spreadValues({ method: "user.getWeeklyTrackChart" }, firstInput), params))).weeklytrackchart;
        res.meta = (0, caster_1.convertMeta)(res["@attr"]);
        delete res["@attr"];
        res.tracks = (0, caster_1.toArray)(res.track).map((e) => {
          e.artist.name = e.artist["#text"];
    ...
    var HelperClass = class {
      ...
      async getCombo(firstInput, limit) {
        ...
        while (firstInput.limit > 0 && combo[0] === combo[1] && combo[1] === combo[2] && combo[2] === true) {
          ...
          page++;
          let res = await this.lastfm.user.getRecentTracks(__spreadProps(__spreadValues({}, firstInput), { page }));
          if (page === 1) {
      ...
      async getNowPlaying(firstInput, detailTypes = [], params = { extended: true }) {
        var _a;
        firstInput = (0, caster_1.convertString)(firstInput, "user", __spreadValues({ detailTypes }, params));
        ...
        const username2 = curr.meta.user;
      ...
      async fetchDetails(username2, detailTypes, artist, album, track, params) {
        let promises = [];
        let options = {
          username: username2
        };
...
var getLastFmSongs_exports = {};
__export(getLastFmSongs_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getLastFmSongs_exports);
var import_lastfm_typed = __toESM(require_dist());
var LASTFM_API_KEY = "6b80e497ca219bfb7fce91ff07c18acd";
var username = "Dani_Duese";
var handler = async () => {
  var _a, _b, _c, _d;
  if (!LASTFM_API_KEY)
    return {
  ...
  try {
    const lastFm = new import_lastfm_typed.default(LASTFM_API_KEY);
    ...
    const origin = process.env.NODE_ENV === "production" ? "https://bitstore.dev" : "http://localhost:8888";
    const mapTrack = (track) => {
      ...
      const object = {
        artist,
        name: track.name,
        image: (_a2 = track.image.find((image) => image.size === "large")) == null ? void 0 : _a2.url,
        url: track.url,
        date: (_b2 = track.date) == null ? void 0 : _b2.uts,
        nowPlaying: track.nowplaying
      };
      if (track.playcount)
        object.plays = track.playcount;
      return object;
    };
    const mapArtist = (artist) => {
      ...
      const object = {
        name: artist.name,
        image: (_a2 = artist.image.find((image) => image.size === "large")) == null ? void 0 : _a2.url,
        url: artist.url
      };
      if (artist.playcount)
        object.plays = artist.playcount;
      return object;
    };
    const formattedUserInfo = {
      name: info.name,
      image: (_a = info.image.find((image) => image.size === "large")) == null ? void 0 : _a.url,
      url: info.url,
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        recentTracks: ((_b = recentTracks == null ? void 0 : recentTracks.tracks) == null ? void 0 : _b.map(mapTrack)) || [],
        topTracks: ((_c = topTracks == null ? void 0 : topTracks.tracks) == null ? void 0 : _c.map(mapTrack)) || [],
        topArtists: ((_d = topArtists == null ? void 0 : topArtists.artists) == null ? void 0 : _d.map(mapArtist)) || []
      })
    };
  } catch (error) {
    console.log(error);
...
//# sourceMappingURL=getLastFmSongs.js.map
