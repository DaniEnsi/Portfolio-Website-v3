exports.ids = [75,0,21,36,51,60,61,62,63];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/components/Card/Repository.vue?vue&type=template&id=5ceed58c&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c,
      _setup = _vm._self._setupProxy;
  ...
  return _c('div', {
    staticClass: "rounded-lg cursor-pointer flex flex-col h-full p-4 transition-colors text-gray-500 justify-between focus-ring dark:text-neutral-500 hover:bg-gray-200/40 dark:hover:bg-neutral-800/40"
  }, [_vm._ssrNode("<div class=\"space-y-2\">", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass(null, _vm.top && 'flex justify-between space-x-2') + ">", "</div>", [_vm._ssrNode("<h3 class=\"text-gray-700 items-center truncate dark:text-neutral-400\"><span class=\"text-gray-400 dark:text-neutral-700\">DaniEnsi / </span>" + _vm._ssrEscape(_vm._s(_vm.name) + "\n      ") + "</h3> "), _vm.top === true ? _c('IconStar', {
    staticClass: "h-6 text-yellow-600 w-6",
    attrs: {
      "title": "Top repository",
      "filled": ""
    }
  }) : _vm._e()], 2), _vm._ssrNode(" <p class=\"text-gray-500 line-clamp-2 dark:text-neutral-500\">" + _vm._ssrEscape("\n      " + _vm._s(_vm.description) + "\n    ") + "</p>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-4\">", "</div>", [_vm._ssrNode("<div class=\"flex items-center justify-between\"><span>Stars:</span> <span>" + _vm._ssrEscape(_vm._s(_vm.stars)) + "</span></div> "), _vm._ssrNode("<div class=\"flex items-center justify-between\">", "</div>", [_vm._ssrNode("<span>Language:</span> "), _c('IconDev', {
    staticClass: "h-5 w-5",
    attrs: {
      "brand": _vm.getLanguageIcon
    }
  })], 2), _vm._ssrNode(" " + (_vm.license ? "<div class=\"flex items-center justify-between\"><span>License:</span> <span>" + _vm._ssrEscape(_vm._s(_vm.license)) + "</span></div>" : "<!---->"))], 2)], 2);
};

var staticRenderFns = [];

// CONCATENATED MODULE: ./src/components/Card/Repository.vue?vue&type=template&id=5ceed58c&
...
/* nuxt-component-imports */
installComponents(component, {IconStar: __webpack_require__(117).default,IconDev: __webpack_require__(109).default})
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/me/repos.vue?vue&type=template&id=05249869&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c,
      _setup = _vm._self._setupProxy;
  ...
  return _c('div', {
    staticClass: "text-gray-500 dark:text-neutral-600"
  }, [_vm._ssrNode("<header class=\"space-y-2 my-12 px-4\"><h1 class=\"text-gray-900 text-4xl dark:text-neutral-300\">Repositories</h1> <p>My public projects on GitHub.</p></header> "), _vm._ssrNode("<main>", "</main>", [_vm.$fetchState.pending === true ? _vm._ssrNode("<div class=\"grid gap-4 md:grid-cols-2\">", "</div>", _vm._l(9, function (i) {
  ...
  }), 1) : _vm._ssrNode("<div class=\"grid gap-4 md:grid-cols-2\">", "</div>", _vm._l(_vm.repos, function (repo, index) {
    return _c('SmartLink', {
      key: `repo-${index}`,
      attrs: {
        "href": repo.html_url,
...
// CONCATENATED MODULE: ./src/pages/me/repos.vue?vue&type=template&id=05249869&
...
/* harmony default export */ var reposvue_type_script_lang_ts_ = (external_vue_default.a.extend({
  ...
  async fetch() {
    ...
    const filter = ["DaniEnsi"];
    const repos = (await this.$axios.get("https://api.github.com/users/daniensi/repos?per_page=100")).data;
...
/* nuxt-component-imports */
installComponents(component, {SkeletonLoader: __webpack_require__(95).default,CardRepository: __webpack_require__(149).default,SmartLink: __webpack_require__(9).default})
