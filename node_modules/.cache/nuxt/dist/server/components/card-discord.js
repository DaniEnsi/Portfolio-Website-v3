...
// CONCATENATED MODULE: ./src/assets/files/premid/largeImages.ts
const general = [{
...
/* harmony default export */ var largeImages = ([{
  name: "General",
  items: general
}, {
  name: "Brand",
...
// CONCATENATED MODULE: ./src/assets/files/premid/smallImages.ts
const smallImages_general = [{
  name: "DoNotDisturb",
...
/* harmony default export */ var smallImages = ([{
  name: "General",
  items: smallImages_general
}, {
  name: "Brand",
  items: smallImages_brand
}]);
