  ...
  <div class="text-gray-500 dark:text-neutral-600">
    <header class="space-y-2 my-12 px-4">
      ...
      <p>
        ...
        <SmartLink href="/daily-song" class="underline"
    ...
    <main v-else class="space-y-20">
        ...
        <div class="grid px-4 gap-x-0 gap-y-4 md:gap-x-12 md:grid-cols-2">
          ...
          <div class="flex space-x-4 items-center justify-between">
            ...
            <div class="flex space-x-2 items-center">
              <SmartLink
                href="https://last.fm/user/Dani_Duese"
                class="flex-shrink-0"
                blank
          ...
          <div class="flex space-x-4 items-center justify-between">
            ...
            <div class="flex space-x-2 items-center">
              <div class="truncate">{{ lastFm.user.totalPlays * 73 }}</div>
      ...
      <div>
        ...
        <div class="grid gap-2 md:grid-cols-2">
          <CardLastFm v-for="song of lastFm.recentTracks" :key="song.name" :name="song.name" :artist="song.artist"
            :image="song.image" :now-playing="song.nowPlaying" :url="song.url" />
        </div>
      </div>
