exports.ids = [62,0,21,25,54,55,56,57,59];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/windicss-webpack-plugin/dist/loaders/windicss-template.cjs!./src/pages/donate.vue?vue&type=template&id=8e14dcc6&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c,
      _setup = _vm._self._setupProxy;
  ...
  return _c('div', {
    staticClass: "py-4"
  }, [_vm._ssrNode("<div class=\"space-y-12 text-gray-500 sm:w-9/12 dark:text-neutral-600\">", "</div>", [_vm._ssrNode("<header class=\"space-y-2 my-12 px-4\"><h1 class=\"text-gray-700 text-4xl dark:text-neutral-300\">Donate</h1> <p>\n        If you like my projects and/or what I do and you want to contribute,\n        make me happy, you can donate to me with the information on this page!\n        Thank you ♥\n      </p> <p class=\"text-xs\">\n        P.S. Use &quot;<span class=\"border-b border-black/10 dark:border-white/10\">Abdulbaki Dursun</span>&quot; as the name of your transactions.\n      </p></header> "), _vm._ssrNode("<section class=\"space-y-4\">", "</section>", [_c('Title', [_vm._v("Support Me On")]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"flex flex-wrap gap-x-4 gap-y-2 mx-4\">", "</div>", [_c('Button', {
    directives: [{
      name: "tippy",
      rawName: "v-tippy",
      value: {
...
// CONCATENATED MODULE: ./src/pages/donate.vue?vue&type=template&id=8e14dcc6&
...
/* harmony default export */ var donatevue_type_script_lang_ts_ = (external_vue_default.a.extend({
  data() {
    return {
      sponsors: [],
      accounts: [{
  ...
  async fetch() {
    const {
      data
    } = await this.$axios.get("https://raw.githubusercontent.com/eggsy/.github/main/sponsors.json");
    this.sponsors = data;
  },
...
// CONCATENATED MODULE: ./src/pages/donate.vue?vue&type=script&lang=ts&
 /* harmony default export */ var pages_donatevue_type_script_lang_ts_ = (donatevue_type_script_lang_ts_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./src/pages/donate.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_donatevue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  null,
