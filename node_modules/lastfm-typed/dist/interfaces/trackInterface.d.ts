import { Image, TagUrlCount, TagWUrl, TrackBasic, Wiki, ArtistOptionalMBID, GlobalTrackOptionalMBID, UserResolvable } from "./shared";
interface Metadata {
    artist: string;
}
...
export declare type getInfoInput = getTagsInput & UserResolvable;
